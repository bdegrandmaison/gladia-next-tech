...
import {
  ...
  TranscribeVideoTextVideoTranscriptionPostParamsModel,
} from "./data-contracts";
...
export namespace Video {
   ...
   */
  export namespace ModelsVideoTextVideoTranscriptionGet {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = ModelsVideoTextVideoTranscriptionGetData;
  }
   ...
   */
  export namespace TranscribeVideoTextVideoTranscriptionPost {
    export type RequestParams = {};
    export type RequestQuery = {
      /**
       * Model
    ...
    export type RequestBody = BodyTranscribeVideoTextVideoTranscriptionPost;
    export type RequestHeaders = {};
    export type ResponseBody = TranscribeVideoTextVideoTranscriptionPostData;
  }
}
